...
// yg aktif dlm satu waktu jg). SELALU pakai HTTPS (WiFiClientSecure +
// setInsecure(), skip validasi sertifikat) -- pola umum di proyek hobi
// ESP32, bukan paling aman scr kriptografis tapi cukup buat baca API
// publik spt ini. url harus diawali "https://".
//
