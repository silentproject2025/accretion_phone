...
static void redrawBox() {
  ...
  float w = 42, h = 62, d = 8; // proporsi disesuaikan biar pas di canvas 280x90
  Vec3 local[8] = {
...
void orientasi3dScreenShow() {
  ...
  int ty = 46 + CANVAS_H + 6; // canvas diperkecil dikit + spasi label dirapetin
                               // biar label terakhir gak numpuk tombol Back
  ...
  lv_obj_set_pos(s_accelLbl, 14, ty + 14);
  ...
  lv_obj_set_pos(s_gyroLbl, 14, ty + 28);
  ...
  lv_obj_set_pos(s_tempLbl, 14, ty + 42);
