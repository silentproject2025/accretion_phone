...
// Init urutan: display.init() + rotasi landscape + kalibrasi touch
// (fungsi loadOrRunCalibration() lama silakan dipindah/panggil dari sini
// kalau kalian sudah port fungsi NVS-nya -- untuk sekarang fondasi ini
// jalankan calibrateTouch() polos tiap boot kalau belum ada data NVS).
void displayHwInit();
