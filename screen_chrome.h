...
// Toast kecil di bawah layar, fade-out sendiri (~1.2 detik) -- dulu
// duplikat di home_screen.cpp, sekarang reusable dipakai app manapun
// (mis. "Data baterai diperbarui", "Tersimpan", dst).
