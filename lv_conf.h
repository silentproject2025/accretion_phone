...
// Widget yang dipakai (LVGL default-nya widget2 ini sudah ON, tapi
// dieksplisitkan di sini biar jelas & gak gampang ke-nonaktifin gak sengaja
// kalau lv_conf.h ini diedit lagi nanti).
#define LV_USE_LABEL       1
#define LV_USE_BTN         1
#define LV_USE_IMG         1
#define LV_USE_BAR         1
#define LV_USE_SLIDER      1   // dipakai app Neopixel (kecerahan)
#define LV_USE_BTNMATRIX   1   // dipakai app Kalkulator
#define LV_USE_CHART       1   // dipakai app HWmonitor (grafik histori CPU)
#define LV_USE_TEXTAREA    1   // dipakai text_input.h (SSID/password/dll)
#define LV_USE_KEYBOARD    1   // dipakai text_input.h (keyboard on-screen)
#define LV_USE_CANVAS      1   // dipakai app Orientasi3D (gambar wireframe manual)
#define LV_USE_ARC         1   // dibutuhkan LV_USE_SPINNER
#define LV_USE_SPINNER     1   // dipakai app Trivia (loading saat fetch soal)
