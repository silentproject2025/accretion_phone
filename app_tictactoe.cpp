...
static void buildGameUI(lv_obj_t* scr) {
  ...
  for (int i = 0; i < s_n * s_n; i++) {
    ...
    lv_obj_set_size(cell, cellSize - 3, cellSize - 3);
    lv_obj_set_style_margin_left(cell, 1, 0);
    lv_obj_set_style_margin_right(cell, 1, 0);
    lv_obj_set_style_margin_top(cell, 1, 0);
    lv_obj_set_style_margin_bottom(cell, 1, 0);
