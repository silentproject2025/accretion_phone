...
void statusBarCreate(lv_obj_t* parent) {
  ...
  // SENGAJA transparan (gak ada bg_color/bg_opa lagi) -- versi sblmnya
  // dikasih bg_color(T().surface)+LV_OPA_COVER, itu yg keliatan kayak
  // "petak/garis panjang" horizontal di atas tiap layar. Sekarang blend
  // nyatu sama bg layar masing2, gak ada garis pemisah lagi.
